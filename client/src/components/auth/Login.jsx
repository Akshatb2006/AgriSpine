...
const Login = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center p-4 transition-colors">
      <button
        onClick={toggleTheme}
        className="fixed top-4 right-4 p-2 rounded-lg bg-white shadow-lg text-gray-600 hover:bg-gray-50:bg-gray-700 transition-colors z-40"
      >
      ...
      {error && (
        <div className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 ease-in-out ${
          ...
          <div className="bg-red-50/20 border border-red-200 rounded-lg p-4 shadow-lg max-w-md min-w-80">
            <div className="flex items-start space-x-3">
              ...
              <button
                onClick={hideError}
                className="text-red-400 hover:text-red-600:text-red-300 transition-colors flex-shrink-0"
              >
                <X size={16} />
              </button>
            </div>
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
          <div className="flex mb-6 rounded-lg overflow-hidden border border-gray-200">
            <button
              className={`flex-1 py-2 transition-colors ${mode === 'login' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-700'}`}
            ...
            <button
              className={`flex-1 py-2 transition-colors ${mode === 'signup' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-700'}`}
          ...
          {mode === 'login' ? (
            <form onSubmit={handleLogin} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors"
              ...
              <button
                ...
                className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-300:bg-gray-600 disabled:cursor-not-allowed text-white font-medium py-3 px-4 rounded-lg transition-colors focus:ring-2 focus:ring-green-500 focus:ring-offset-2:ring-offset-gray-800"
              >
                {loading ? (
            ...
            <form onSubmit={handleSignup} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full py-3 px-3 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors"
                  disabled={loading}
                >
