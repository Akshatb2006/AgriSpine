      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          {alerts.map((alert) => {
            ...
            return (
              <div key={alert.id} className="bg-red-50/20 border border-red-200 rounded-lg p-4">
          ...
          {insights.map((insight) => {
            ...
            return (
              <div key={insight.id} className="bg-yellow-50/20 border border-yellow-200 rounded-lg p-4">
                <div className="flex items-start space-x-3">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-3">
          {upcomingTasks.map((task) => (
            <div key={task.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50:bg-gray-700 transition-colors cursor-pointer">
              <div className="flex-1">
