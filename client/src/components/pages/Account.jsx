  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
          ...
          {!editing ? (
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                disabled={saving}
                className="flex items-center space-x-2 text-gray-600 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg transition-colors"
              >
                <X size={14} />
                <span>Cancel</span>
              </button>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-green-900 dark:text-green-100">Total Farm Area</h4>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-blue-900 dark:text-blue-100">Active Fields</h4>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center space-x-3 p-3 text-left hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors border border-red-200 dark:border-red-800"
        >
