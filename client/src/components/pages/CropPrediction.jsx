          ...
          <div
            className={`w-12 h-12 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${
              step <= currentStep
                ...
                : 'bg-gray-200 dark:bg-gray-700 text-black dark:text-white opacity-60'
            }`}
          >
            {step < currentStep ? (
              <CheckCircle size={20} />
  ...
  const renderStep1 = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-black dark:text-white mb-2">Basic Information</h2>
        <p className="text-lg text-black dark:text-white opacity-70">Tell us about your crop and field details</p>
      </div>
            ...
            <button
              ...
              className={`group p-4 rounded-xl border-2 text-center transition-all duration-200 hover:scale-105 ${
                formData.cropType === crop.value
                  ...
                  : 'border-black dark:border-white hover:border-green-300 dark:hover:border-green-600 hover:bg-gray-50 dark:hover:bg-gray-700'
              }`}
            >
              <div className="text-3xl mb-2 group-hover:scale-110 transition-transform">{crop.icon}</div>
              <div className="font-semibold text-black dark:text-white mb-1">{crop.label}</div>
              <div className="text-xs text-black dark:text-white opacity-60">{crop.description}</div>
            </button>
          ))}
        </div>
        {errors.cropType && (
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-black text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors text-lg"
            />
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-black text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors text-lg"
            />
          </div>
          {errors.location && (
            <p className="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
            ...
            <button
              ...
              className={`p-4 rounded-xl border-2 text-left transition-all duration-200 hover:scale-105 ${
                formData.soilType === soil.value
                  ...
                  : 'border-black dark:border-white hover:border-blue-300 dark:hover:border-blue-600 hover:bg-gray-50 dark:hover:bg-gray-700'
              }`}
            >
              <div className="font-semibold text-black dark:text-white mb-1">{soil.label}</div>
              <div className="text-sm text-black dark:text-white opacity-60">{soil.description}</div>
            </button>
          ))}
        </div>
        {errors.soilType && (
  ...
  const renderStep2 = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-black dark:text-white mb-2">Agricultural Details</h2>
        <p className="text-lg text-black dark:text-white opacity-70">Information about your farming practices</p>
      </div>
          ...
          {irrigationTypes.map((irrigation) => (
            ...
            >
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div className="font-semibold text-black dark:text-white">{irrigation.label}</div>
              </div>
              <div className="text-sm text-black dark:text-white opacity-60">{irrigation.description}</div>
            </button>
          ))}
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-black dark:text-white opacity-60 flex items-center">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {fertilizerTypes.map((fertilizer) => (
            ...
            >
              <div className="font-semibold text-black dark:text-white mb-1">{fertilizer.label}</div>
              <div className="text-sm text-black dark:text-white opacity-60">{fertilizer.description}</div>
            </button>
          ))}
        </div>
      </div>
  ...
  const renderStep3 = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-black dark:text-white mb-2">Additional Information</h2>
        <p className="text-lg text-black dark:text-white opacity-70">Optional details to improve prediction accuracy</p>
      </div>
            ...
            <button
              ...
              className={`p-4 rounded-xl border-2 text-left transition-all duration-200 hover:scale-105 ${
                formData.weatherConcerns.includes(concern.value)
                  ...
                  : 'border-black dark:border-white hover:border-orange-300 dark:hover:border-orange-600 hover:bg-gray-50 dark:hover:bg-gray-700'
              }`}
            >
              <div className="flex items-center space-x-3 mb-2">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-black text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors resize-none text-lg"
        />
      </div>
    ...
    <div className="max-w-6xl mx-auto">
      ...
      {loading && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-black rounded-2xl p-8 max-w-md mx-auto text-center shadow-2xl">
            ...
            <p className="text-black dark:text-white opacity-70 mb-6 text-lg">
      ...
      <div className="mb-6">
        <button
          ...
          className="flex items-center space-x-2 text-black dark:text-white opacity-70 hover:text-gray-800 dark:hover:text-gray-200 transition-colors group"
        >
      ...
      <div className="bg-white dark:bg-black rounded-2xl shadow-xl border border-black dark:border-white overflow-hidden">
        {/* Header */}
        ...
        <div className="p-8">
          ...
          <div className="flex justify-between items-center pt-8 border-t border-black dark:border-white">
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 text-black dark:text-white opacity-70 hover:text-gray-800 dark:hover:text-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              <ChevronLeft size={20} />
            ...
            <div className="text-center">
              <div className="text-sm text-black dark:text-white opacity-60 mb-1">
