...
const PlanDetails = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'in-progress':
        return 'text-blue-600 bg-blue-100/20';
      case 'pending':
        return 'text-yellow-600 bg-yellow-100/20';
      case 'skipped':
        return 'text-gray-600 bg-gray-100/20';
      default:
        return 'text-gray-600 bg-gray-100/20';
    }
  };
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      case 'high':
        return 'text-red-600 bg-red-100/20';
      case 'medium':
        return 'text-yellow-600 bg-yellow-100/20';
      case 'low':
        return 'text-green-600 bg-green-100/20';
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            <div className="bg-red-100/20 rounded-lg p-3">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <button className="flex items-center space-x-2 text-green-600 hover:text-green-700:text-green-300">
                  <Plus size={16} />
                  <span>Add Task</span>
                </button>
              </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        {isTaskOverdue(task) && (
                          <span className="px-2 py-1 bg-red-100/20 text-red-700 rounded-full text-xs font-medium">
                            Overdue
                          </span>
                        )}
                      </div>
                      ...
                      {task.instructions && (
                        <div className="bg-blue-50/20 border border-blue-200 rounded-lg p-3 mb-2">
                      ...
                      {task.notes && (
                        <div className="bg-yellow-50/20 border border-yellow-200 rounded-lg p-3 mb-2">
                      ...
                      <div className="flex items-center space-x-3">
                        <button
                          ...
                          className="text-gray-500 hover:text-gray-700:text-gray-300 text-sm"
                        >
                        ...
                        {task.status === 'in-progress' && (
                          <button
                            onClick={() => updateTaskStatus(task.id, 'pending')}
                            disabled={updatingTask === task.id}
                            className="text-yellow-600 hover:text-yellow-700:text-yellow-300 text-sm"
                          >
                            Pause Task
                          </button>
                        )}
                      ...
                      {showTaskNotes[task.id] && (
                        <div className="mt-3">
                          ...
                          <div className="flex justify-end space-x-2 mt-2">
                            <button
                              onClick={() => toggleTaskNotes(task.id)}
                              className="px-3 py-1 text-gray-600 hover:text-gray-800:text-gray-200 text-sm"
                            >
                              Cancel
                            </button>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="font-medium text-gray-900">{plan.field?.name}</p>
              </div>
              <div>
              ...
              <div className="space-y-3">
                {plan.aiRecommendations.map((rec, index) => (
                  <div key={index} className="border border-blue-200 rounded-lg p-3">
                    ...
                    <p className="text-blue-800 text-sm mb-2">{rec.recommendation}</p>
                    {rec.reasoning && (
                      <p className="text-blue-600 text-xs">{rec.reasoning}</p>
                    )}
                    {rec.confidence && (
                      <div className="mt-2">
                        ...
                        <div className="w-full bg-blue-100/20 rounded-full h-1 mt-1">
                          <div 
                  ...
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    {resource.estimatedCost && (
                      <div className="text-right">
                        ...
                        <p className="text-xs text-gray-500">{resource.timing}</p>
                      </div>
                    )}
                  </div>
                ))}
