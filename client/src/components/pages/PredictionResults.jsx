...
const PredictionResults = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <div className="bg-green-100/20 rounded-full p-6 w-24 h-24 mx-auto mb-4 flex items-center justify-center">
          ...
          <div className="bg-blue-50/20 border border-blue-200 rounded-lg p-4 max-w-md mx-auto">
  ...
  if (error || prediction?.status === 'failed') {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <div className="bg-red-100/20 rounded-full p-6 w-24 h-24 mx-auto mb-4 flex items-center justify-center">
          ...
          <div className="space-x-4">
            ...
            <button
              ...
              className="bg-gray-100 hover:bg-gray-200:bg-gray-600 text-gray-700 px-6 py-2 rounded-lg font-medium transition-colors"
            >
              Back to Dashboard
            </button>
          </div>
  ...
  const getRiskColor = (risk) => {
    switch (risk) {
      case 'low': return 'text-green-600 bg-green-100/20';
      case 'medium': return 'text-yellow-600 bg-yellow-100/20';
      case 'high': return 'text-red-600 bg-red-100/20';
    ...
    <div className="space-y-6">
      ...
      {predictionData.explanation && (
        <div className="bg-blue-50/20 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-blue-700">{predictionData.explanation}</p>
        </div>
      )}
    </div>
  );
  ...
  const renderRecommendations = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">Actionable insights to optimize your yield</p>
      </div>
      ...
      {predictionData.seasonalAdvice && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <h4 className="font-medium text-gray-900 mb-2">Critical Periods</h4>
              <ul className="text-gray-600 text-sm space-y-1">
  ...
  const renderRiskAnalysis = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">Potential risks and mitigation strategies</p>
      </div>

      {/* Overall Risk */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="text-center">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Overall Risk Level</h3>
      ...
      {predictionData.sustainability && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-medium text-gray-900 mb-2">Water Efficiency</h4>
            ...
            <div>
              <h4 className="font-medium text-gray-900 mb-2">Sustainability Suggestions</h4>
              <ul className="text-gray-600 text-sm space-y-1">
  ...
  const renderWeatherData = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900">Weather Analysis</h2>
  ...
  const renderDetails = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">Input data and analysis metadata</p>
      </div>

      {/* Input Summary */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Input Data Summary</h3>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-gray-600">Crop Type:</span>
              <span className="font-medium text-gray-900 capitalize">{inputData?.cropType}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Field Size:</span>
              <span className="font-medium text-gray-900">{inputData?.fieldSize} acres</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Location:</span>
              <span className="font-medium text-gray-900">{inputData?.location}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Soil Type:</span>
              <span className="font-medium text-gray-900 capitalize">{inputData?.soilType}</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-900 capitalize">{inputData?.irrigationType}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              <span className="text-gray-600">Previous Yield:</span>
              <span className="font-medium text-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-900 font-mono text-sm">{predictionId}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {inputData?.notes && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-gray-600">{inputData.notes}</p>
        </div>
      )}
    </div>
  );
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          <button
            onClick={() => navigate('/prediction')}
            className="flex items-center space-x-2 text-gray-600 hover:text-gray-800:text-gray-200 transition-colors"
          >
            <ArrowLeft size={16} />
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <span className="px-3 py-1 bg-green-100/20 text-green-700 rounded-full text-sm font-medium">
              Analysis Complete
            </span>
          </div>
        </div>
      ...
      {/* Feedback Section */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Was this prediction helpful?</h3>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <button className="flex items-center space-x-2 px-4 py-2 text-green-600 hover:bg-green-50:bg-green-900/20 rounded-lg transition-colors">
              <ThumbsUp size={16} />
              <span>Yes, helpful</span>
            </button>
            <button className="flex items-center space-x-2 px-4 py-2 text-red-600 hover:bg-red-50:bg-red-900/20 rounded-lg transition-colors">
              <ThumbsDown size={16} />
